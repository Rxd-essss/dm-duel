...
const RND_SUN_I = 0.37;
const RND_SUN_NOSHADOW = 0.29;
...
let RND_exposure = 2.15;         // какая линейная яркость станет средне-серой
...
let RND_AMB_LO = 1.26;   // доля непрямого света на уровне пола
let RND_AMB_HI = 1.34;   // и под кровлей
...
function initThree(){
  ...
  scene.fog = new THREE.Fog(0xc0aa8b, 18, 240);
  ...
  hemi = new THREE.HemisphereLight(0xb9cce3, 0xb3906b, 1.40); scene.add(hemi);
  sun = new THREE.DirectionalLight(0xeaf2ff, RND_SUN_I);
  ...
  RND_rim = new THREE.DirectionalLight(0x9dc4ff, 1.20);
  RND_rim.position.set(-90,46,-34); scene.add(RND_rim);
  RND_rim2 = new THREE.DirectionalLight(0x9dc4ff, 0.86);
  RND_rim2.position.set(90,40,40); scene.add(RND_rim2);
...
const LIGHTS = {
  ...
  mul: 1.23,        // постоянные источники карты

...
const TX_GEN = {
  ...
  dirt(g,S){
    ...
    // масляные пятна под станинами: холодные и тёмные, единственный не-земляной тон
    const oil = TX_ink(0.86, 0.90, 0.98);
    for(let i=0;i<4;i++)
      TX_soft(g,S,oil, TX_rr(0,S), TX_rr(0,S), TX_rr(0.06,0.15)*S, TX_rr(0.34,0.58), TX_rr(0.55,0.9), TX_rr(0.4,1.0), TX_rr(0,3.14));
    TX_speck(g,S,ink,300,0.5*u,1.8*u,0.58,0.94,0.3);
    g.save();
    g.globalCompositeOperation = 'multiply';
    for(let i=0;i<7;i++)
      TX_soft(g,S,ink, TX_rr(0,S), TX_rr(0,S), TX_rr(50,112)*u, TX_rr(0.40,0.62), TX_rr(0.85,1.0), TX_rr(0.5,1.0), TX_rr(0,3.14));
    for(let i=0;i<9;i++)
      TX_soft(g,S,ink, TX_rr(0,S), TX_rr(0,S), TX_rr(20,50)*u, TX_rr(0.60,0.90), TX_rr(0.5,0.85), TX_rr(0.5,1.0), TX_rr(0,3.14));
    g.globalCompositeOperation = 'screen';
    for(let i=0;i<6;i++)
      TX_soft(g,S,ink, TX_rr(0,S), TX_rr(0,S), TX_rr(44,100)*u, TX_rr(0.30,0.52), TX_rr(0.85,1.0), TX_rr(0.5,1.0), TX_rr(0,3.14));
    for(let i=0;i<7;i++)
      TX_soft(g,S,ink, TX_rr(0,S), TX_rr(0,S), TX_rr(18,46)*u, TX_rr(0.16,0.34), TX_rr(0.6,0.9), TX_rr(0.5,1.0), TX_rr(0,3.14));
    g.restore();
  }
};

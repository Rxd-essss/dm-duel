...
const TX_TONE = {
  ...
  rust:  { lvl:0.82, con:1.15 },
  conc:  { lvl:0.61, con:1.50 },
  stone: { lvl:0.60, con:1.30 },
  sand:  { lvl:0.60, con:1.45 },
  cloth: { lvl:0.66, con:1.35 },
  roof:  { lvl:0.74, con:1.20 },
  crate: { lvl:0.62, con:1.30 },
  grass: { lvl:0.82, con:1.20 },
  dirt:  { lvl:0.82, con:1.20 }

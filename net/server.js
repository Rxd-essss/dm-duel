...
const SPAWNS = [
  // 0 = BLU, комната снабжения южного сруба
  [ {x:0,y:0.05,z:-64.5}, {x:-5,y:0.05,z:-64.5}, {x:5,y:0.05,z:-64.5},
    {x:-7.5,y:0.05,z:-61.5}, {x:7.5,y:0.05,z:-61.5} ],
  // 1 = RED, комната снабжения северного сруба
  [ {x:0,y:0.05,z:64.5}, {x:5,y:0.05,z:64.5}, {x:-5,y:0.05,z:64.5},
    {x:7.5,y:0.05,z:61.5}, {x:-7.5,y:0.05,z:61.5} ]
];

...
/* ====================== ТОЧКИ РЕСПАВНА ====================== */
/* Зеркало SPAWNS_BLU / SPAWNS_RED из src/45_map.js. Настил гнезда базы стоит
   на плоской площадке FLATS (h=2.2) плюс 4.8 м конструкции = 7.0; наземные
   точки RED лежат на той же площадке. Клиент всё равно доводит игрока своей
   физикой, серверу нужна только осмысленная точка появления. */
const SPAWNS = [
  // 0 = BLU, осадный лагерь на юге
  [ {x:-4,y:2.3,z:-71}, {x:4,y:2.3,z:-71}, {x:0,y:2.3,z:-74},
    {x:-8.5,y:2.3,z:-73}, {x:8.5,y:2.3,z:-73} ],
  // 1 = RED, двор замка на севере
  [ {x:-5,y:2.3,z:76.4}, {x:-1.7,y:2.3,z:76.4},
    {x:1.7,y:2.3,z:76.4}, {x:5,y:2.3,z:76.4} ]
];
...
const PICKS = [
  { x:  0,   z: 70,   y:15.00, heal:50, cd:22 },   //  0 кровля донжона
  { x:  2.6, z:-56.4, y:15.00, heal:50, cd:22 },   //  1 осадная башня BLU
  { x:  5,   z:  0,   y:15.00, heal: 0, cd:18 },   //  2 мост посада, центр
  { x:-16,   z:  0,   y:15.00, heal: 0, cd:18 },   //  3 мост посада, запад
  { x: 16,   z:  0,   y:15.00, heal: 0, cd:18 },   //  4 мост посада, восток
  { x:-52,   z: -2,   y: 7.50, heal:50, cd:22 },   //  5 западный фланг, ярус 1
  { x: 52,   z:  2,   y: 7.50, heal:50, cd:22 },   //  6 восточный фланг, ярус 1
  { x:-11,   z:  7,   y: 8.20, heal: 0, cd:18 },   //  7 перекрытия посада, запад
  { x: 11,   z: -7,   y: 8.20, heal: 0, cd:18 },   //  8 перекрытия посада, восток
  { x:  2,   z: 34,   y: 3.29, heal:25, cd:13 },   //  9 северный подступ
  { x: -2,   z:-34,   y: 3.29, heal:25, cd:13 },   // 10 южный подступ
  { x:-27,   z: 34,   y: 4.73, heal: 0, cd:18 },   // 11 северный подступ, запад
  { x: 27,   z:-34,   y: 4.73, heal: 0, cd:18 },   // 12 южный подступ, восток
  { x: -8.6, z: 60.5, y: 2.20, heal:25, cd:13 },   // 13 двор замка
  { x: 14,   z:-66,   y: 2.20, heal:25, cd:13 },   // 14 лагерь BLU
  { x:-52,   z:-20,   y: 1.19, heal: 0, cd:18 },   // 15 западный фланг, земля
  { x: 52,   z: 20,   y: 1.19, heal: 0, cd:18 }    // 16 восточный фланг, земля
];

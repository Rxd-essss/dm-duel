...
const SPAWNS = [
  [ {x:-5,y:7.1,z:-64}, {x:5,y:7.1,z:-64}, {x:0,y:7.1,z:-66} ],                     // 0 = BLU
  [ {x:-5,y:7.1,z:64},  {x:5,y:7.1,z:64},  {x:-15,y:2.3,z:58},
    {x:15,y:2.3,z:58},  {x:0,y:2.3,z:74} ]                                          // 1 = RED
];
...
const PICKS = [
  { x:-4.8, z:  2.2, y:10.15, heal:50, cd:22 },   //  0 крыша форта
  { x:  0,  z:-11.5, y:14.00, heal: 0, cd:18 },   //  1 южный мост
  { x:  0,  z: 11.5, y:14.00, heal: 0, cd:18 },   //  2 северный мост
  { x:-46,  z:  6,   y:16.18, heal: 0, cd:18 },   //  3 вышка западного двора
  { x:-38,  z: -4,   y: 1.40, heal:50, cd:22 },   //  4 западный двор, земля
  { x: 46,  z: -6,   y:16.18, heal: 0, cd:18 },   //  5 вышка восточного двора
  { x: 38,  z:  4,   y: 1.40, heal:50, cd:22 },   //  6 восточный двор, земля
  { x:  9,  z:-56,   y: 2.20, heal:25, cd:13 },   //  7 предполье BLU
  { x: -9,  z:-56,   y: 2.20, heal: 0, cd:18 },   //  8 предполье BLU
  { x:-26,  z:-42,   y: 5.77, heal:25, cd:13 },   //  9 площадка троса BLU
  { x: -9,  z: 56,   y: 2.20, heal:25, cd:13 },   // 10 предполье RED
  { x:  9,  z: 56,   y: 2.20, heal: 0, cd:18 },   // 11 предполье RED
  { x: 26,  z: 42,   y: 5.77, heal:25, cd:13 },   // 12 площадка троса RED
  { x:-20,  z:-41,   y: 2.22, heal:25, cd:13 },   // 13 среднее поле, запад
  { x: 20,  z: 41,   y: 2.22, heal:25, cd:13 },   // 14 среднее поле, восток
  { x:-21,  z: 12,   y: 4.43, heal: 0, cd:18 },   // 15 подступ к плато, запад
  { x: 21,  z:-12,   y: 4.43, heal: 0, cd:18 }    // 16 подступ к плато, восток
];
